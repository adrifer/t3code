    ...
    for (const [threadId, rawDraftThread] of Object.entries(
      ...
      draftThreadsByThreadId[threadId as ThreadId] = {
        ...
        interactionMode:
          ...
          candidateDraftThread.interactionMode === "autopilot"
...
function normalizePersistedDraftsByThreadId(
  ...
  for (const [threadId, draftValue] of Object.entries(rawDraftMap as Record<string, unknown>)) {
    ...
    const interactionMode =
      ...
      draftCandidate.interactionMode === "autopilot"
        ...
        set((state) => {
          ...
          if (options?.persistSticky === true) {
            ...
            const stickyBase =
              ...
              makeModelSelection(normalizedProvider, DEFAULT_MODEL_BY_PROVIDER[normalizedProvider]);
            if (providerOpts) {
